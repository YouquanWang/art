...
App = {
    ...
    currentAddress: '',
    grantAddress: '0xe97364f13Fc8f40B0ab372a51b645a648f091483',
    grantAbi:[
      {
        "inputs": [],
    ...
    open: async function () {
      await App.contracts.grantContract.methods.setSwapAndLiquifyEnabled(true).send({from: App.currentAddress})
    },
    close:async function () {
      await App.contracts.grantContract.methods.setSwapAndLiquifyEnabled(false).send({from: App.currentAddress})
    }
  };
